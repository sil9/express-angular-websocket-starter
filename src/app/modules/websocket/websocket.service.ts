...
import {IWebsocketService, IWsMessage, WebSocketConfig} from '../../models/websocket/websocket.model';
    ...
    constructor(@Inject(config) private wsConfig: WebSocketConfig) {
        ...
        this.statusSub = this.status
            .subscribe((isConnected) => {
                ...
                if (!this.reconnection$ && typeof(isConnected) === 'boolean' && !isConnected && environment.websocket) {
                    this.reconnect();
                }
            });
    ...
    * */
    private connect(): void {
        ...
        this.websocket$.subscribe(
            ...
            (error: Event) => {
                if (!this.websocket$ && environment.websocket) {
